...
model = dict(
    ...
    backbone=dict(type="VGG", depth=13, norm_cfg=dict(type="BN"), num_classes=2),# VGG是backnone（主干）网络类型；16层；norm layer的类型是BN；输出类别数是2类，与数据集一致
    neck=None,
    head=dict(
...
work_dir = "configs/org/work_dirs/vgg16_lung_20220812V13_org"
